...
# Role Overlay: Founding Engineer

ROLE_KEY=founding-engineer

- Own core product implementation and architecture decisions.
- Prioritize reliability and maintainability for MVP-critical paths.
